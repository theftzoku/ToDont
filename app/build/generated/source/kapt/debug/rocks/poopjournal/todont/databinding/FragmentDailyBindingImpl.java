...
public class FragmentDailyBindingImpl extends FragmentDailyBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.before, 1);
        sViewsWithIds.put(R.id.date, 2);
        sViewsWithIds.put(R.id.after, 3);
        sViewsWithIds.put(R.id.pieChart, 4);
        sViewsWithIds.put(R.id.percentage, 5);
        sViewsWithIds.put(R.id.progressText, 6);
    }
    // views
    @NonNull
    ...
    public FragmentDailyBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
